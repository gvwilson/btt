...
[%b Michaelson2004 %].  As long as their teams work well, they achieve higher grades, retain information
...
FIXME for running meetings, making decisions, and resolving conflicts
...
half a dozen members.  Anything larger
...
once ([%x cogload %]) that's as big as a team can practically be.
...
(FIXME) help groups coordinate more effectively, but the groups
...
be a hitchhiker, and make scheduling meetings much
more difficult.
...
One surprising finding is that having students with a range of grades in the same team either has no
...
much you know about your teammates' work (FIXME).
...
The biggest headache when instructors select teams is scheduling.  COVID-19 has made distributed work
...
All right, you've formed a team: now what? How do you decide who does what? How do
...
status than others, and what is or isn't considered important usually
...
confirmation loop: since women and people of color
...
(FIXME). Many take a third path and decide to leave
programming—after all, why play a game that's unfair?

<blockquote markdown="1">
### In the beginning

Programming was originally considered a
...
of labor, a phenomenon known as Conway's Law or socio-technical congruence [%b Cataldo2008 %]. In a
modular decomposition, each person is
...
2.  It leads to big bang integration, in which all the components meet each other for the
...
Functional decomposition, in which each
...
functionally, the self-appointed alpha geeks will
...
Finally, there is rotating decomposition: everyone
...
Any of these strategies is better than chaotic decomposition, which unfortunately is the most common approach. If people
...
Asking people on a team to rate their peers is
...
FIXME are a useful starting point.
...
isn't on this list, please see FIXME.
