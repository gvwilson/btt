...
rules can help, and can be read as a complement to FIXME.
...
:   This is a corollary of the previous three points.  As you learn your way
    ...
    mental model of how it works ([%x cogload %]).  Offering a small
...
anything from a simple checklist like the one in FIXME to a
