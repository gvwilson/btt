...
blank: True
title: "Wrapping Up"
tag: "What to do at the end of a project"
syllabus:
- FIXME
---
...
1.  An architectural overview, including a block diagram of the major components
    and a walkthrough of how it behaves.  (I prefer the use-case maps introduced in FIXME for this.)
...
Another possible deliverable is a package that other people can download and install. It isn't an either/or choice: every good package has a home page,
...
You may also be asked to do some marketing,
...
The usual way to do this is with version numbers.  Most projects these days use
semantic versioning;
...
The major version
number is only incremented when significant changes are made. In
...
Minor version
numbers are what most people think of as releases. If you've added a few
...
Patches don't have their own installers. If, for example,
...
The build number is incremented every time you create a new version of the product
...
The other thing student projects usually have to deliver is some kind of final report. Most students short-change this part of
...
:   This should not just summarize the analysis & estimation
    ...
    observer, and so on (FIXME). As with the introduction, the
...
:   What did the team learn about teamwork? What went well? What should they
    ...
    possible.  (The checklists in FIXME and
    FIXME may be useful starting points.)
...
WYSIWYG editors like Microsoft Word and LibreOffice. Unfortunately, these get in the way at least
...
For these reasons, most teams format their reports as a set of Markdown pages under version control and
...
and screenshots work well, and you can embed [MathML][mathml] for equations if you need to.  The downside
is that you can't actually see what your document is going to look like until
you compile it, and doing that breaks your flow.

<blockquote markdown="1">
### LaTeX

LaTeX is a markup language that's much more sophisticated
...
grade you're given: it's the post mortem. Literally, this is an examination of a deceased person; in a
