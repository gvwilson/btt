...
blank: True
title: "Process"
tag: "How to structure your time"
syllabus:
- FIXME
---

A development process defines who does what, when, in order to build a piece of
...
I think about process in terms of feedback loops
...
Unit testing.
:   Many developers are passionate about a technique called test-driven development, where you write
...
:   As discussed in FIXME, building the software and running
...
Code review.
:   FIXME explained when, why, and how to do this.
...
helps to look at the Boehm Curve,
...
The term agile was coined in 2001
...
student projects; we will look at one form called Scrum.
...
Scrum breaks development down into short sprints, typically no more than two weeks long, and sometimes
...
A typical working day starts with a stand-up meeting where everyone in the team reports what they
...
to recover, go back and re-read FIXME.)  At this
...
This process is called analysis & estimation (A&E).  The result is a short document, typically 1--5 pages
...
on any given day, but to tell you when you should start cutting corners.  Suppose that you have ten weeks in order to
...
:   This is also very popular, but is quickly self-defeating.  As
    FIXME explained, the quality of your work goes down when
...
responsibilities is to triage the issues in a
project's issue tracker ([%x communicate %]) periodically and adjust
the schedule accordingly. The effort-importance grid that you drew at the start will help with
...
[Neil Brown][brown-neil] and the [Blackbox][blackbox] project, the frequency with which features
